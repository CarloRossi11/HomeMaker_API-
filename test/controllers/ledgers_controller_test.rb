...
class LedgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post ledgers_url, params: { ledger: { project_id: @ledger.project_id, qty: @ledger.qty, resource_id: @ledger.resource_id } }, as: :json
    end
  ...
  test "should update ledger" do
    patch ledger_url(@ledger), params: { ledger: { project_id: @ledger.project_id, qty: @ledger.qty, resource_id: @ledger.resource_id } }, as: :json
    assert_response 200
  end
